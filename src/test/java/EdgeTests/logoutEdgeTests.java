...
public class logoutEdgeTests extends EdgeTestSetupObject {
    @DataProvider
    ...
    public void verifyLogoutAfterLogin(String username, String password){
        ...
        RegisteredUser user = new RegisteredUser(getDriver());
        Assert.assertTrue(user.isLogoutButtonDisplayed(), "The logout button is not displayed!");
        user.logOut();
